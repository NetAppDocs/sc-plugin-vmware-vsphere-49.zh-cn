...
* 在SAN (VMFS)环境中执行还原操作需要使用VMware Storage vMotion
+
...
有关受支持版本的最新信息，请参见 https://imt.netapp.com/matrix/imt.jsp?components=112310;&solution=1517&isHWU&src=IMT["NetApp 互操作性表工具"^] IMT
